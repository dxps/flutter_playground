...
///
class _CalculateDistanceState extends State<CalculateDistanceScreen> {
  //
  ...
  Future<void> _onCalculatePressed() async {
    //
    final List<String> startCoords = _startCoordinatesTextController.text.split(',');
    final List<String> endCoords = _endCoordinatesTextController.text.split(',');
    ...
    final double distance =
        await Geolocator().distanceBetween(startLatitude, startLongitude, endLatitude, endLongitude);
    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          child: TextField(
            decoration: const InputDecoration(hintText: 'start latitude,start longitude'),
        ...
        Container(
          padding: const EdgeInsets.all(8.0),
          child: TextField(
            decoration: const InputDecoration(hintText: 'end latitude,end longitude'),
