...
///
///
class LocationStreamScreen extends StatefulWidget {
  //

  @override
  State<LocationStreamScreen> createState() => LocationStreamState();

  //
}

///
class LocationStreamState extends State<LocationStreamScreen> {
  //
  ...
  void _toggleListening() {
    if (_positionStreamSubscription == null) {
      ...
      _positionStreamSubscription =
          positionStream.listen((Position position) => setState(() => _positions.add(position)));
  ...
  Widget _buildListView() {
    ...
    listItems.addAll(_positions.map((Position position) => PositionListItem(position)).toList());
  ...
  Widget _buildButtonText() => Text(_isListening() ? 'Stop listening' : 'Start listening');

  Color _determineButtonColor() => _isListening() ? Colors.red : Colors.green;
...
class PositionListItemState extends State<PositionListItem> {
  ...
  Future<void> _onTap() async {
    ...
    final List<Placemark> placemarks =
        await Geolocator().placemarkFromCoordinates(_position.latitude, _position.longitude);
